...
function game_over_screen() {
    ...
    game_over_text.innerHTML = `GAME OVER. Spurs Defeat the Gunners in ${time}..<div class="score_div"><img src="/images/spurs.png"><h2>${food_count}</h2></div><a id="play_again" href="/index.html">Play Again</a>`
